...
* [Firebase Crashlytics](https://firebase.google.com/support/privacy/) (if applicable)

### 3. Log Data
In the event of an error in the app, we collect data and information (through third-party products) on your phone called Log Data. This may include your device IP address, device name, operating system version, and the time/date of your use.
